...
initial structure contained only enough feilds to control each specific command
of a service. Any security or checksum features were left up to the participants
to develope and deploy. 
...
game and the code. Very little code was actaully being written, but design flaws
and vulnerabilities were slowly being realized. One or two members of Team A
had previous experience in UNIX System Admnistration and immediately began
setting up monitoring tools to track incomming requests and log the commands
