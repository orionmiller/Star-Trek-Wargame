...
>>>>>>> c697019b22230c640a0ae13f12ce843e63e2cbd1
...
our flag generater program and update the flag for the specific task and then let
...
the base functionality given to the players to compile their service. [ see base 
...
functionality and way to guarentee that the service was running. We did this
...
This communicates with the internal functionality checking.
...
Our challenge was similar to other traditional CTFs except it did not have a defence
...
=======
To better deter players from reverse engineering our base functionality encrypted packing of the base functionality, would be an extra deterrent of people being
...
hard to have a fair and balanced scoring scheme.
...
needs to be a better metric than just checking the service up times. It would definitely 
be a factor in the score but shouldn't really be the majority of the score.
